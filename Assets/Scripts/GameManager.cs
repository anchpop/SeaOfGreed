...
namespace SeaOfGreed {
    ...
    public class GameManager : MonoBehaviour {
        ...
        private Dictionary<String, Vector2> roomPositions;
        private Dictionary<String, List<GameObject>> TileAssociations = new Dictionary<string, List<GameObject>>();
        ...
        private void getRooms() {
            rooms = Resources.LoadAll("", typeof(GameObject))
                .Select(x => (GameObject)x)
                .Where(prefab => prefab.GetComponent<Tiled2Unity.TiledMap>() != null)
                .Where(prefab => prefab.name.ToLower().Contains("programmer") == onlyShowProgrammerMaps)
                .Select(prefab => new RoomData(prefab)).ToList();
        }
        ...
        private void getTransitionAssociations() {
